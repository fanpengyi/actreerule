...
//        System.out.println(sb.toString());
    ...
    public static void main(String[] args){
        ...
        try {
            String lineTxt = null;
            String content = "";
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("./resources/test.txt")),
                    "UTF-8"));
...
//            content = br.toString();
            ...
            for(String reg :regs){
                boolean z=test.isContainChinese(content,reg);
                if(z){
...
//            boolean f=test.isContainChinese(content,reg1);
//            while ((lineTxt = br.readLine()) != null) {
